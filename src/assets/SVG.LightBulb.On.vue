<template>
	<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 24 24">
		<g class="text-color-fill" fill="#ffc107">
			<path
				class="text-color-stroke"
		...
		></path>
		<!-- <path fill="#ffd54f" d="m15.75 12.5c-.414 0-.75-.336-.75-.75 0-1.517-1.233-2.75-2.75-2.75-.414 0-.75-.336-.75-.75s.336-.75.75-.75c2.343 0 4.25 1.907 4.25 4.25 0 .414-.336.75-.75.75z"></path> -->
	</svg>
</template>
...
svg {
	...
	.glow {
		filter: drop-shadow(
			calc(0px * var(--size-scale)) calc(0px * var(--size-scale)) calc(5px * var(--size-scale))
				rgba(var(--text-color))
		);
	}
}
